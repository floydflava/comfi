        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    ...
                    return redirect('rope:cardpayment', payment_option='card')
...
class CardPaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            return render(self.request, "cardpayment.html", context)
        else:
            messages.warning(
                self.request, "You have not added a billing address")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            return redirect("rope:product", slug=slug)
    else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("rope:request-refund")
